...
echo $i" |"$cy"     INDONESIA DARK TERMUX ASSOCIATE
                               EWAKO LAKAJA PUNYA CERITA"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Rafly pake i  [LAKAJA-PALOPO-SULSEL]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Rafly pake i"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.R4FLY] [MR.RAHUL] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AlAMSYAH]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 082290232340"$i"             |"
echo $i" |"$pu" Contack facebook :"$ku" Rafly pake i"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB BR1G4D3    "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB Rafly     "$i"|"$i"    |"$cy" N"$i" |"
...
sleep 2
echo $ku"WhatsApp :"$i"082290232340 "
echo $ku"Facebook :"$i" Rafly pake i"
echo $ku"youtube:"$i"Rafly pake i"
sleep 2
